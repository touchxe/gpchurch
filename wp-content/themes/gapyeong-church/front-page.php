...
<section class="quick-menu-section">
    <div class="container">
        <div class="quick-menu-box">
            ...
            <!-- 3. 오시는 길 -->
            <a href="/intro/location" class="quick-item">
                <div class="quick-icon">
                    <svg viewBox="0 0 64 64" fill="none">
                        <defs>
    ...
    <div class="container">
        ...
        <div class="activity-cta" data-aos="fade-up">
            <div class="activity-cta-content">
                ...
                <a href="/community/contact" class="btn btn-white">활동 참여 문의하기</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="team-showcase" data-aos="fade-up">
            ...
            <div class="team-showcase-right">
                ...
                <a href="/intro/location" class="team-cta-btn">오시는 길</a>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="church-info-box" data-aos="fade-up">
            ...
            <div class="info-row info-row-contact">
                ...
                <a href="/community/contact" class="contact-cta-btn">
